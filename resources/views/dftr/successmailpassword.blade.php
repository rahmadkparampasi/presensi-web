                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <div class="alert alert-success alert-dismissible pr-3 pl-3" role="alert">
                                <strong class="text-center">Pengiriman Email Reset Password Berhasil Dilakukan<br/><br/></strong>
                                <p class="text-justify">Silahkan Cek Email Untuk Melakukan Reset Password.</p>
                            </div>
