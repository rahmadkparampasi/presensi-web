                ...
                <div class="row align-items-center text-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <br/>
                            <div class="alert alert-danger alert-dismissible pr-3 pl-3" role="alert">
                                <strong class="text-center">MAAF YAH!<br/><br/></strong>
                                <p class="text-justify">Kami ingin menyampaikan permohonan maaf atas ketidaknyamanan yang terjadi akibat gangguan sistem yang saat ini sedang dalam proses perbaikan. Tim teknis kami sedang bekerja keras untuk menyelesaikan masalah ini secepat mungkin.<br/><br/>

                                Kami berterima kasih atas kesabaran dan pengertian Anda. Sistem akan segera diaktifkan kembali dan dapat digunakan seperti biasa dalam waktu dekat.<br/><br/>
                                    
                                Terima kasih atas kepercayaan Anda, dan sekali lagi kami mohon maaf atas ketidaknyamanan ini. </p>
                            </div>

                            {{-- <a href="{{route('register')}}" class="btn btn-block btn-info text-white mb-4"><i class="fa fa-users"></i> DAFTAR LAGI</a> --}}
