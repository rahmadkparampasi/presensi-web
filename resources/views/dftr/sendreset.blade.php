                ...
                <div class="row align-items-center text-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <form class="form-contact contact_form" action="{{route('register.insert.resetpassword')}}" method="post" novalidate="novalidate">
                                @csrf
                                
                                <div class="form-group mb-3 text-justify">
                                    <input type="text" class="form-control" placeholder="Email Pengguna" id="email" name="email" value="{{old('email')}}" required>
