                ...
                <div class="row align-items-center text-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <h4 class="mb-2 f-w-bold">VERIFIKASI EMAIL</h4>
                            <br/>
                            @if ($success=='1')
                                <div class="alert alert-success alert-dismissible pr-3 pl-3" role="alert">
                                    <strong class="text-center">Verifikasi Email Berhasil Dilakukan<br/><br/></strong>
                                    <p class="text-justify">{{$msg}}</p>
                                </div>
                            @else
                                <div class="alert alert-danger alert-dismissible pr-3 pl-3" role="alert">
                                    <strong class="text-center">Verifikasi Email Tidak Berhasil Dilakukan<br/><br/></strong>
                                    <p class="text-justify">{{$msg}}</p>
                                </div>
                            @endif

                            <a href="{{route('masuk')}}" class="btn btn-block btn-info text-white mb-4"><i class="fa fa-users"></i> MASUK</a>
