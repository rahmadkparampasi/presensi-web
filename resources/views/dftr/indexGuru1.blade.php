                        ...
                        <div class="card-body">
                            ...
                            <form class="form-contact contact_form" action="{{route('register.insertGuru')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3 text-left">
                                    ...
                                    <label for="sisp_idsp">NIP (Nomor Induk Pegawai) / KTP (Bagi Yang Belum ASN/PPPK)</label>
                                ...
                                <div class="form-group mb-3 text-left">
                                    <label for="sisp_nmd">Gelar Depan</label>
                                    <input type="text" class="form-control border rounded border-dark" placeholder="Ketik Disini" id="sisp_nmd" name="sisp_nmd" value="{{old('sisp_nmd')}}" required>
                                    @error('registerError')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3 text-left">
                                    <label for="sisp_nmb">Gelar Belakang</label>
                                    <input type="text" class="form-control border rounded border-dark" placeholder="Ketik Disini" id="sisp_nmb" name="sisp_nmb" value="{{old('sisp_nmb')}}" required>
                                    @error('registerError')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3 text-left">
                                    <label for="sispdp_setstspeg">Status Pegawai</label>
                                    <select type="text" class="form-control border rounded border-dark" id="sispdp_setstspeg" name="sispdp_setstspeg" value="{{old('sispdp_setstspeg')}}" required >
