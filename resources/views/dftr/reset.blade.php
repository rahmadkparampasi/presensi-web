...
<head>
    <title>SIMETRI | REGISTRASI</title>
    ...
    <!-- Meta -->
    <meta charset="utf-8">
    <meta name="keywords" content="SIMETRI"/>
                ...
                <div class="row align-items-center text-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <h3 class="mb-0 f-w-bold">SIMETRI</h3>
                            <p class="mb-5 f-w-400">SISTEM INFORMASI MANAJEMEN TERPADU RISET DAN INOVASI</p>
                            <h4 class="mb-2 f-w-bold">RESET PASSWORD</h4>
                            <br/>
                            @if ($errors->any())
                            ...
                            <form class="form-contact contact_form" action="{{route('register.insert.resetpasswordNew')}}" method="post" novalidate="novalidate">
                                @csrf
                                
                                <div class="form-group mb-3">
                                    <input type="hidden" class="form-control" id="users_id" name="users_id" required value="{{$users_id}}">

                                    <input type="password" class="form-control" placeholder="Password Baru" id="password" name="password" required value="{{old('password')}}">
                                    {{-- <small class="text-left">Password digunakan untuk mengakses aplikasi. Hanya dapat menggunakan angka dan huruf (A-Z, a-z, 0-9) dan Tidak Boleh Menggunakan Simbol (.,*- dll)</small> --}}
                                </div>
                                <div class="form-group mb-3">
                                    <input type="password" class="form-control" placeholder="Ulangi Password Baru" id="password1" name="password1" required value="{{old('password1')}}">
                                </div>
                                
                                <button type="submit" class="btn btn-block btn-primary mb-2">SIMPAN</button>
                            ...
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://bappelitbangda.parigimoutongkab.go.id/" target="_blank" class="font-weight-bold" target="_blank">BAPPELITBANGDA</a><br/>
